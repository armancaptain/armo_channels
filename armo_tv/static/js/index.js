window.addEventListener("dragover",function(e){
  ...
  handle_file = (element,file)=>{
    ...
    reader.onload = function fileReadCompleted() {     
            ...
            delete_el(element,'droped-video')
            const vid = new VideoPlaybackQuality;          // creates an <vid> element
            vid.src = reader.result;         // loads the data URL as the video source
            vid.className = "droped-video"
            element.appendChild(vid);   // adds the video to the body        
